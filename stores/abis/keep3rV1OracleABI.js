export const keep3rV1OracleABI = [
    ...
    outputs: [
      {
        ...
        internalType: "struct Keep3rV1Oracle.Observation",
        name: "",
        type: "tuple"
      }
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_keep", type: "uint256" }],
    name: "setMinKeep",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function"
  ...
  },
  {
    ...
    name: "stddev",
    outputs: [{ internalType: "uint256", name: "sd", type: "uint256" }],
    stateMutability: "pure",
    type: "function"
  },
  {
